...
You need to install the swift gem. It includes ruby bindings to dbicpp and is also
a funky minimal ORM.

  require 'swift'

  h = Swift::DBI::Handle.new user: "udbicpp", driver: "postgresql", database: "dbicpp"
...
* cursor support, function calls, async queries and a lot more.
