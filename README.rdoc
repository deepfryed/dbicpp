...
You can run these yourself if you're keen.

* Create a database called 'dbicpp' on your local MySQL and PostgreSQL server.
* Make sure you have ruby 1.9.1 and rubygems installed.
* Install ruby bindings from http://github.com/shanna/swift
